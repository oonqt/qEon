...
exports.run = async (client, message, args, config) => {
  if (message.member.roles.cache.has(config.rankperm)) {
    ...
    const rankdogjfhfk = new discord.MessageEmbed()
      ...
      .setColor("GREEN")
      .setDescription(
        `We have found ${rodopoop}, Would you like to demote ${rodopoop} to ${robloxrankinfo.name}?`
      )
      .setFooter(config.embed.footer + " | Ranking command");
    const maxrank = new discord.MessageEmbed()
      ...
      .setDescription(
        `Error: We can not demote ${rodopoop} because ${rodopoop} is to high of a rank to demote`
      )
      .setFooter(config.embed.footer + " | Ranking command");
            ...
            .then((collected) => {
              ...
              if (reaction.emoji.name === "✅") {
                ...
                const rankeddrfugsd = new discord.MessageEmbed()
                  ...
                  .setColor("GREEN")
                  .setDescription(`We have demoted ${rodopoop}!`)
                ...
                if (config.robloxlogchannel === "true") {
                  const ranklog = new discord.MessageEmbed()
                    ...
                    .addField("Action type:", "Demote", true)
